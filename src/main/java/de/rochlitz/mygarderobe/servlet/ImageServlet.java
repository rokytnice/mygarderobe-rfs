package de.rochlitz.mygarderobe.servlet;
...
public class ImageServlet extends HttpServlet {
     ...
     * 
     */
    private static final long serialVersionUID = 8564029831094632330L;
    ...
    public void init() throws ServletException {
        ...
        this.imagePath = MyGarderobeConstant.upload_dir_name;
    ...
    //TODO hier nochmal prüfen ob zugriff auf bilder erlaubt ist
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        throws ServletException, IOException
    {

	HttpSession session = request.getSession();
	Principal currentuser = request.getUserPrincipal();//TODO zugriffsrechte prüfen
